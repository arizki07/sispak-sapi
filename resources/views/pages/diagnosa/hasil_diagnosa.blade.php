                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-md-7 text-center hero-text">
                            ...
                            <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Hasil diagnosis ini berdasarkan perhitungan sistem menggunakan metode
                                certainty factor.</p>
                                <a href="{{ route('downloadpdf') }}" class="btn btn-primary" data-aos="fade-up" data-aos-delay="100">Download Hasil Diagnosis</a>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
              <div class="feature-1 text-center">
                ...
                <p class="font-weight-bold" style="font-size: 20px;">{{ $resultDiagnosa['tingkat_kepercayaan'] }}</p>
              </div>
            </div>
                  ...
                  <div class="swiper-slide">
                    <div class="review text-center">
                      ...
                      <p class="review-user">
                        ...
                        <span class="d-block">
                          <span class="text-black">Nilai CF : {{ $penyakit['nilai_cf'] }}</span>, &mdash; Presentase : {{ $penyakit['nilai_cf'] * 100 }} %
                        </span>
                      </p>
...
<footer class="footer" role="contentinfo">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-md-7">
                <p class="copyright">&copy; Copyright {{ date('Y') }} <a href="https://www.instagram.com/rifki_sebastian" target="_blank" class="link-secondary">Moch Rifki Sebastian</a>.</p>
                <div class="credits">
