        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm" style="background-image: url(assets/static/images.png)"></span>
                    <div class="d-none d-xl-block ps-2">
                        <div>{{ Auth::user()->name }}</div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="/penyakit" class="dropdown-item">Data Penyakit</a>
                    <a href="/gejala" class="dropdown-item">Data Gejala</a>
                    <a href="/relasi" class="dropdown-item">Data Relasi</a>
                    <a href="/diagnosa" class="dropdown-item">Data Diagnosa</a>
